...
expr :
  ...
  | NOT expr                            { make_expr (Monop (Not, $2)) }
  | MINUS expr %prec UMINUS             { make_expr (Monop (Uminus, $2)) }
  | expr MULOP expr                     { make_expr (Binop ($2, $1, $3)) }
  | expr ADDOP expr                     { make_expr (Binop ($2, $1, $3)) }
